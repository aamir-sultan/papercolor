...
fun! s:register_default_theme()
  ...
  let s:themes['default'].light = {
        ...
        \       'color16' : ['#0087af', '31'],
        \       'color17' : ['#008700', '28'],
        \       'cursor_fg' : ['#ebdeb1', '255'],
        \       'cursor_bg' : ['#005f87', '24'],
        \       'cursorline' : ['#e6d289', '254'],
        \       'cursorcolumn' : ['#e6d289', '254'],
        \       'cursorlinenr_fg' : ['#af5f00', '130'],
        \       'cursorlinenr_bg' : ['#e6d289', '255'],
        \       'popupmenu_fg' : ['#444444', '238'],
        \       'popupmenu_bg' : ['#ebdeb1', '252'],
        \       'search_fg' : ['#444444', '238'],
        \       'search_bg' : ['#ffff5f', '227'],
        \       'incsearch_fg' : ['#ffff5f', '227'],
        \       'incsearch_bg' : ['#444444', '238'],
        \       'linenumber_fg' : ['#b2b2b2', '249'],
        \       'linenumber_bg' : ['#ebdeb1', '255'],
        \       'vertsplit_fg' : ['#e6d289', '24'],
        \       'vertsplit_bg' : ['#ebdeb1', '255'],
        \       'statusline_active_fg' : ['#e6d289', '254'],
        \       'statusline_active_bg' : ['#005f87', '24'],
        \       'statusline_inactive_fg' : ['#444444', '238'],
        \       'statusline_inactive_bg' : ['#e6d289', '252'],
        \       'todo_fg' : ['#00af5f', '35'],
        \       'todo_bg' : ['#ebdeb1', '255'],
        \       'error_fg' : ['#af0000', '124'],
        \       'error_bg' : ['#ffd7ff', '225'],
        ...
        \       'tabline_active_bg':   ['#e6d289', '254'],
        \       'tabline_inactive_fg': ['#ebdeb1', '255'],
        \       'tabline_inactive_bg': ['#0087af', '31'],
        \       'buftabline_bg':          ['#005f87', '24'],
        \       'buftabline_current_fg':  ['#444444', '238'],
        \       'buftabline_current_bg':  ['#e6d289', '254'],
        \       'buftabline_active_fg':   ['#ebdeb1', '255'],
        \       'buftabline_active_bg':   ['#005faf', '25'],
        \       'buftabline_inactive_fg': ['#ebdeb1', '255'],
...
let s:to_HEX = {
      ...
      \ '250': '#bcbcbc',  '251': '#c6c6c6',  '252': '#e6d289',  '253': '#dadada',  '254': '#e6d289',
      \ '255': '#ebdeb1' }
